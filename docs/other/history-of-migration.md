...
- [x] main-script.js (unified allItems)
  - [x] Tumne dikhaya: main-script.js
...
- [x] index.html (checked, compatible)
  ...
  - [x] Maine dekha: partials aur main-script.js load karta hai, direct items.json fetch nahi, migration ka asar nahi
---

## 8️⃣ Migration History

- 2025-07-15: Migration plan banaya, field mapping kiya, items.json schema ready kiya.
- 2025-07-16: main-script.js, item-details.js, explore-view.js migrate kiye. cart-view.js, saved-view.js check kiye.
...
main-script.js ab sirf allItems use karta hai (firebase/data/items.json), aur allProducts/allServices ko sessionStorage me set nahi karta. Filtering ab JS me hoti hai.
