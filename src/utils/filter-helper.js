...
import { loadComponent } from '/src/utils/partial-auto-loader.js';
import { fetchAllCategories, fetchAllBrands } from '/src/utils/data-manager.js';
import { showToast } from '/src/utils/toast.js'; // Import the toast utility

const PLACEHOLDER_ID = 'filter-bar-placeholder';
const COMPONENT_PATH = '/src/components/filter-bar.html';
