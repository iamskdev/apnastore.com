import { fetchAllItems, fetchUserById } from '/src/utils/data-manager.js';
...
function createProductCard(item) {
    ...
    const defaultImagePath = '/localstore/Images/default-product.jpg';
...
async function initializeUserHomePage() {
    ...
    container.addEventListener('click', (e) => {
        ...
        if (target) {
            ...
            // Dispatch a global event that main-script.js will catch to change the view.
